...
while($month < 17)
{
	...
	while($day < 32)
	{
		if($month == 14 && ( $day == 12 || $day == 14))
			$day++;
		else if($month == 16 && $day == 14)
		{
			$done = true;
			break;
		}
		...
		{	if($day < 10)
			{
				findGames("2015".$month."0".$day);
				echo "<br>2015".$month."0".$day;
			}
			else
			{
				findGames("2015".$month.$day);
				echo "<br>2015".$month.$day;
			}
		}
		else
		{
			...
			if($day < 10)
			{
				findGames("20160". ($month-12) ."0" .$day);
				echo "<br>20160".($month-12) . "0" . $day;
			}
			else
			{
				echo "<br>20160".($month-12) .$day;
				findGames("20160". ($month-12) .$day);
			}
		}
		$day = $day + 1;
	}
